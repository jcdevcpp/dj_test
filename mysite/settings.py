...
DATABASES = {
    "default": {
        ...
        "PASSWORD": "miniturris",
        "HOST": "localhost",
        #        "HOST": "jc2021.mysql.pythonanywhere-services.com",
        "OPTIONS": {
            "init_command": "SET sql_mode='STRICT_TRANS_TABLES'",
            # to prevent data loss due to truncation, errors raised instead warn
        },
    }
}
...
try:
    ...
    print(
        "When you want to use social login, please see mysite/github_settings-dist.py"
    )
